...
- [`vlm/nemotron-3.5-super/`](vlm/nemotron-3.5-super/README.md) runs Nemotron 3.5 Super VLM training with TP=4 inference, four trainer GPUs, inline routed-expert and sampling-mask replay, NCCL weight transfer, and W&B.
