...
AlgorithmConfig: TypeAlias = vf.AlgorithmConfig
...
class HostedModelConfig(PolicyModelConfig):
    """A non-policy model endpoint that prime-rl can connect to by key."""
...
class OrchestratorConfig(BaseConfig):
    model: PolicyModelConfig = PolicyModelConfig()
