...
class OrchestratorConfig(BaseConfig):
    ...
    use_renderer: Annotated[
        ...
        Field(
            ...
            "(name / tool_parser / reasoning_parser / pool_size) applies. Default for both text-only and "
            "VLM rollouts; VLMs require it. Set to False to fall back to MITO (``openai_chat_completions``) "
            "for external teacher rollouts."
        ),
    ] = True
