...
class OrchestratorConfig(BaseConfig):
    ...
    uniform reward carries no gradient, so training on it is wasted compute. Rollouts that were
    never scored (opd/opsd train through reference KL, not credit) are unaffected."""
