...
per minute you can click to narrow to a moment — and `subset: "effective"`
switches it to step mode, which shows the cohort that shipped at one step. Use optional `trace` and `branch` indices
