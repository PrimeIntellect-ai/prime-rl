...
- The bump alone ships nothing. The new code reaches users after prime-kernels publishes a
  release and prime-rl moves the wheel pin below.
...
`prime_kernels-0.1.0+cu129torch2.13.0-cp312-cp312-linux_x86_64.whl`. It imports only under
...
[tool.uv.sources]
prime-kernels = [
    { url = "https://github.com/PrimeIntellect-ai/prime-kernels/releases/download/vX.Y.Z/prime_kernels-0.1.0+cu129torch2.13.0-cp312-cp312-linux_x86_64.whl", marker = "platform_machine == 'x86_64'" },
    { url = "https://github.com/PrimeIntellect-ai/prime-kernels/releases/download/vX.Y.Z/prime_kernels-0.1.0+cu129torch2.13.0-cp312-cp312-linux_aarch64.whl", marker = "platform_machine == 'aarch64'" },
]
```
