...
def test_forward_passes_explicit_seq_lens_for_mrope_images():
    """Qwen-style image batches build MRoPE internally, but packed segment
    lengths are carried explicitly from the data packer."""
