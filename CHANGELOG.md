...
- **`client.client_type`**: Added configurable verifiers client type. Use `openai_chat_completions` for standard `/v1/chat/completions` calls, or `openai_chat_completions_token` for vLLM `/chat/completions/tokens` routing on multi-turn generation (default: `"openai_chat_completions_token"`) (#1846, 2026-02-21)
- **`client.sampling_overrides`**: Added dict for hardcoding/overriding top-level request fields on generation requests, e.g. `{"logprobs": true}` (default: `{}`) (#1846, 2026-02-21)
- **`client.extra_body_overrides`**: Added dict for hardcoding/overriding `extra_body` fields on generation requests, e.g. `{"return_token_ids": true}` (default: `{}`) (#1846, 2026-02-21)
