...
- **`orchestrator.sampling.temp_scheduler`**: Added optional temperature schedule configuration with support for constant, linear, and cosine schedules (2026-01-21)
