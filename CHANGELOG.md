...
- **`orchestrator.sampling.temperature_schedule`**: Added optional temperature schedule configuration with support for constant, linear, and cosine schedules (2026-01-20)
