...
- [`models/glm-5.3/`](https://github.com/PrimeIntellect-ai/prime-rl/tree/main/configs/advanced/models/glm-5.3) — large-scale and P/D-disaggregated inference across the GLM-5 family.
- [`envs/swe-scaleswe.toml`](https://github.com/PrimeIntellect-ai/prime-rl/blob/main/configs/advanced/envs/swe-scaleswe.toml) + [`models/glm-4.5-air/rl/2-nodes-full-offload.toml`](https://github.com/PrimeIntellect-ai/prime-rl/blob/main/configs/advanced/models/glm-4.5-air/rl/2-nodes-full-offload.toml) — train a 100B+ MoE on two nodes: a full-offload trainer paired with one inference replica at batch size 64.
