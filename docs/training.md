...
| `uv run trainer` | Standalone RL trainer. | Direct invocation uses one GPU. Multi-process launches require `torchrun` or a project launcher that configures the distributed environment. |
