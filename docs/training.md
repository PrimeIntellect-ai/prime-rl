...
```bash
uv run sft @ configs/basic/reverse-text/sft.toml --monitors.wandb
```
...
- **Start small.** Run `configs/basic/reverse-text/rl.toml` end-to-end on 2 GPUs before scaling. If the smoke run finishes cleanly, your install is good.
