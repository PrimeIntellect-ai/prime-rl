...
5. [**Hendrycks Sanity**](examples/hendrycks_sanity/README.md): Run the [sanity check](https://arxiv.org/abs/2510.26788) on `DeepSeek-R1-Distill-Qwen-1.5B` using a filtered subset of MATH where the model already partially solves 20-80% of problems. Requires 8 GPUs.
