...
# Configs
export GIT_REF=${GIT_REF:-"service-agent"}
...
export TRAIN_CMD=${TRAIN_CMD:-"uv run rl @ configs/service_agent/rl.toml --output-dir $OUTPUT_DIR"}
