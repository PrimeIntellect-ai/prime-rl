...
from prime_rl_configs._base import BaseConfig
from prime_rl_configs._validation import (
...
from prime_rl_configs.inference import InferenceConfig
from prime_rl_configs.inference import WeightBroadcastConfig as InferenceWeightBroadcastConfig
from prime_rl_configs.orchestrator import (
...
from prime_rl_configs.shared import (
    SlurmConfig,
    WandbConfig,
    WandbWithExtrasConfig,
)
from prime_rl_configs.trainer import (
    BenchConfig,
...
class RLConfig(BaseConfig):
    ...
    def auto_setup_lora(self):
        if self.trainer.model.lora is not None:
            ...
            if self.orchestrator.model.lora is None:
                from prime_rl_configs.orchestrator import LoRAConfig
    ...
    def auto_setup_teacher_inference(self):
        ...
        from prime_rl_configs.orchestrator import TeacherModelConfig
