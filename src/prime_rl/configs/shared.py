...
class PrimeMonitorConfig(BaseConfig):
    ...
    run_name: Annotated[
        str | None,
        Field(
            description="Name for the run shown on the platform. Defaults to the W&B run name if set, otherwise auto-generated by the platform. Only used when RUN_ID is not set (i.e. for local/external runs).",
        ),
    ] = None
    ...
    team_id: Annotated[
        str | None,
        Field(
            description="Team ID to associate the run with. Only used when RUN_ID is not set.",
        ),
    ] = None
