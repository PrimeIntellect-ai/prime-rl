...
TIME_AXIS_GLOBS = ("dispatcher/*", "batcher/last_*", "policy/version", "event_loop_lag/*")


class IntervalLogger:
    """One ``asyncio.Task``. ``await log_loop.start()`` runs until ``stop()``.
    ...
    def __init__(self, orch: "Orchestrator") -> None:
        ...
        self.interval = self.config.experimental.log_loop_interval
