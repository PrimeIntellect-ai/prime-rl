...
def validate_shared_model_name(
    ...
    if inference and inference.model.name != orchestrator.model.name and not allow_different:
        raise ValueError(
