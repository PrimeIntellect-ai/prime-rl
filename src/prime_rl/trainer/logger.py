...
def setup_logger(log_config: LogConfig, world: World, output_dir: Path) -> Logger:
    ...
    logger = setup_handlers(loguru_logger, format, log_config, rank=world.rank, output_dir=output_dir)
    set_logger(logger)
