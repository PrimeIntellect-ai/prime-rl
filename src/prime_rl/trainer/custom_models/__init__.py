...
from prime_rl.trainer.custom_models.qwen3_moe import Qwen3MoeForCausalLM
from prime_rl.trainer.custom_models.configuration_qwen3_moe import Qwen3MoeConfig
...
# Also accept the HF Qwen3MoeConfig class, if present
try:
    from transformers.models.qwen3_moe.configuration_qwen3_moe import (
        Qwen3MoeConfig as HFQwen3MoeConfig,
    )

    _CUSTOM_CAUSAL_LM_MAPPING.register(HFQwen3MoeConfig, Qwen3MoeForCausalLM, exist_ok=True)
except Exception:
    pass
