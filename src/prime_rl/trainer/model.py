...
from prime_rl.utils.vlm import get_language_model, get_vision_encoder, is_vlm_config, resolve_is_vlm
...
def get_model(
    ...
    # Fallback VLM detection from loaded config (catches local paths, only when not explicitly set)
