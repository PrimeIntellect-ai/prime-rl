...
class SFTDataConfig(BaseDataConfig):
    ...
    seed: Annotated[int, Field(description="Random seed to use for shuffling the dataset. We also shuffle at the end of each epoch by adding epoc count to the seed.")] = 0
