...
class GptOssDecoderLayer(GradientCheckpointingLayer):
    def __init__(self, config: GptOssConfig, layer_idx: int):
        ...
        self.self_attn = ATTN_IMPL2CLASS[config._attn_implementation](attention_config)
...
class GptOssPreTrainedModel(PreTrainedModelPrimeRL):
    ...
    # GptOss models don't need format conversion - they use standard HF format for both training and inference
    @classmethod
...
class GptOssForCausalLM(GptOssPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        >>> model = GptOssForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b")
