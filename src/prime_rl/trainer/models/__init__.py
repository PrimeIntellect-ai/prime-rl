...
from prime_rl.trainer.models.hy_v3 import HYV3Config, HYV3ForCausalLM
...
AutoConfig.register("hy_v3", HYV3Config, exist_ok=True)
...
_CUSTOM_CAUSAL_LM_MAPPING.register(HYV3Config, HYV3ForCausalLM, exist_ok=True)
