    ...
    def forward(  # type: ignore[override]
        ...
        for start in range(0, n, chunk_size):
            ...
            for vocab_start in range(0, vocab, vocab_chunk_size):
                ...
                if kept_chunk is not None:
                    kept_local, kept_in_range = _kept_local_indices(kept_chunk, vocab_start, vocab_end)
                    kept_logits = torch.where(kept_in_range, scaled_logits.gather(1, kept_local), kept_logits)
