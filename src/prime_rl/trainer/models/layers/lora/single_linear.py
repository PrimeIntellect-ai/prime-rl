...
class LoRALinear(nn.Module):
    """
    LoRA (Low-Rank Adaptation) linear layer for single-adapter use case.
    ...
    This is used when max_concurrent_runs=1 as it's simpler and avoids
    the overhead of multi-adapter parameter management.
    """
