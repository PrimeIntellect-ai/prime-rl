...
class TrainSink:
    ...
    async def process_group(self, group_id: str) -> None:
        ...
        for trace in survivors:
            ...
            if self.config.constant_trainer_batch_size and self.config.filter_zero_advantages:
    ...
    def process_batch(self) -> TrainBatch:
        ...
        if not self.config.constant_trainer_batch_size and self.config.filter_zero_advantages:
            selected_by_trace = {
