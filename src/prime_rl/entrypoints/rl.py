        ...
        if ttt.enabled and ttt.mode == "online_lora":
            ...
            ttt_cmd = [
                ...
                *ttt.lora.target_modules,
                ...
                "--prompt-loss-weight",
                str(ttt.prompt_lora_loss_weight),
                "--completion-loss-weight",
                str(ttt.completion_lora_loss_weight),
                "--device",
                ttt.learner.device,
                "--dtype",
                ttt.learner.dtype,
...
def write_slurm_script(config: RLConfig, config_dir: Path, script_path: Path) -> None:
    ...
    ttt_template_vars = dict(
        ...
        ttt_prompt_loss_weight=ttt.prompt_lora_loss_weight,
        ttt_completion_loss_weight=ttt.completion_lora_loss_weight,
