...
# Apply patches as fallback for source checkouts / editable installs
# The .pth file handles this for wheel installs, but when running from source
# the .pth file may not be in site-packages yet
apply_patches()
