...
def get_model_and_tokenizer(model_name: str, attn_implementation: AttnImplementation) -> tuple[Model, AutoTokenizer]:
    config_model = AutoConfig.from_pretrained(model_name, attn_implementation=attn_implementation)
